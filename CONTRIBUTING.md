...
5. Confirm the tree opens in the existing official profile, renamed threads refresh, native navigation restores the Codex workspace, and abnormal pointer cancellation does not leave the canvas dragging.
